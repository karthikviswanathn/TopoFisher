...
def calcSavePI(diag, sample=None, res_len = 32):       
    dimPow = 1
    power = float(dimPow)
...
def find_vec(param, hod_list, rsd_list, realization_list, baseDir) :
...
vecs = find_vec(param, hod_list, rsd_list, realization_list, inputFolderName)
